...
final class ProcurementPaymentBatchMarkExportedController extends AbstractApiController
{
    public function __invoke(
        ...
        $exported = $service->markExported($batch, $actor);

        return $this->ok(['payment_batch' => $service->toDetailPayload($exported)]);
    }
}
