...
final class ProcurementPaymentRequestMarkReconciledController extends AbstractApiController
{
    public function __invoke(
        ...
        $reconciled = $service->markReconciled($model, $actor);

        return $this->ok(['payment_request' => $registry->toDetailPayload($reconciled)]);
    }
}
