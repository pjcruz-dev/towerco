...
final class ProcurementRfqCloseBiddingController extends AbstractApiController
{
    public function __invoke(
        ...
        $closed = $service->closeBidding($model, $actor);

        return $this->ok(['rfq' => $registry->toDetailPayload($closed)]);
    }
}
