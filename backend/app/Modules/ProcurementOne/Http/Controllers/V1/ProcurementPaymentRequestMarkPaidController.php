...
final class ProcurementPaymentRequestMarkPaidController extends AbstractApiController
{
    public function __invoke(
        ...
        $paid = $service->markPaid($model, $validated, $actor);

        return $this->ok(['payment_request' => $registry->toDetailPayload($paid)]);
    }
}
