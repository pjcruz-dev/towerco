...
final class ProcurementContractStoreController extends AbstractApiController
{
    public function __invoke(
        ...
        $validated = $request->validate([
            ...
            'vendor_id' => ['required', 'uuid', 'exists:procurement_vendors,id'],
        ...
        $contract = $service->create($validated, $actor);

        return $this->created(['contract' => $registry->toDetailPayload($contract)]);
    }
}
