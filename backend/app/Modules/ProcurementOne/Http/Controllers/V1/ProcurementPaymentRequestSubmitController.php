...
final class ProcurementPaymentRequestSubmitController extends AbstractApiController
{
    public function __invoke(
        ...
        $submitted = $service->submit($model, $actor);

        return $this->ok(['payment_request' => $registry->toDetailPayload($submitted)]);
    }
}
