...
class RolloutRfiRecordedController extends AbstractApiController
{
    public function __invoke(
        ...
        $data = $request->validate([
            'actual_rfi_date' => ['required', 'date'],
        ]);

        $updated = $service->recordRfi($rollout, Carbon::parse($data['actual_rfi_date']));
