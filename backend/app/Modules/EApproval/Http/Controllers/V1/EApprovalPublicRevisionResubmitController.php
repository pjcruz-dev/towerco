...
class EApprovalPublicRevisionResubmitController extends AbstractApiController
{
    public function __invoke(
        ...
        return $this->ok($submissions->resubmit($submission, $data['resubmit_token'], $data['values']));
    }
}
