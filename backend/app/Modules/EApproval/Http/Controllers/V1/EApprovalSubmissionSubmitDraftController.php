...
class EApprovalSubmissionSubmitDraftController extends AbstractApiController
{
    public function __invoke(
        ...
        return $this->ok($service->toDetailPayload($submitted));
    }
}
