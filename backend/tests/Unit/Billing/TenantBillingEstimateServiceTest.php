...
{
    public function test_professional_base_plus_committed_seat_and_tower_addons(): void
    {
        $tenant = new Tenant([
        ...
        $this->assertSame(5, $estimate['committed_extra_tower_licenses']);
        $this->assertSame(75.0, $estimate['seat_addons_monthly']);
        $this->assertSame(125.0, $estimate['tower_addons_monthly']);
        $this->assertSame(299.0, $estimate['estimated_monthly_total']);
    }

    public function test_legacy_rfi_override_keys_still_apply(): void
    {
        $tenant = new Tenant([
            'plan_tier' => 'professional',
            'seat_limit' => 15,
        ...
        $tenant->id = '00000000-0000-0000-0000-000000000098';
