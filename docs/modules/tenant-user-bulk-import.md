...
- Single role: `viewer` or `e_approval_approver`
- Multiple roles in one cell (comma-separated; quote the cell in Excel):  
  `e_approval_approver,e_approval_requestor,e_approval_viewer`
- Semicolon or pipe separators also work: `e_approval_approver;e_approval_viewer`
