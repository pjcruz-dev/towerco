...
| 3 | Open rollout detail → **Timeline** | Phases visible in playbook order (v3: Pre-assessment + MOC before TSSR; Site License + Handover after construction) |
...
| 6b | Pass **Pre-assessment** (MNO) then **MOC/COL** gates | Gates Passed before TSSR (v3 playbook) |
| 7 | Pass **Site Hunting** / TSSR gates on timeline | Gate shows Passed; audit entry created |
...
| 10 | Record **RFI** with actual date | Status `completed`; SLA variance calculated ★ site ready |
| 10b | Pass **Site License** then **Handover to Operations** (v3) | Close-out phases outside 115 WD delivery SLA |
...
See also: [rollout-playbook-phase14.md](./rollout-playbook-phase14.md) · [project-one-roadmap.md](../roadmaps/project-one-roadmap.md)
