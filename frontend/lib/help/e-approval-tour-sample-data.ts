    ...
    workflow_steps: [
      {
        ...
        approver_name: "James Rivera",
        approver_names: ["James Rivera"],
      },
      {
        step_order: 2,
        label: "Approver 2",
        ...
        approver_name: "Alya Mendoza",
        approver_names: ["Alya Mendoza"],
      },
      {
        step_order: 3,
        label: "Approver 3",
        state: "upcoming",
        status_label: "Upcoming",
        approver_name: "Carlos Nguyen",
        approver_names: ["Carlos Nguyen"],
      },
    ],
    requestor: {
