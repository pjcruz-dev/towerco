...
export const TICKETING_TOUR_CHAPTER_STARTS: TicketingTourChapterStart[] = [
  ...
  {
    id: "settings",
    how: "Settings → Ticketing settings → IT assignees, categories, SLA / auto-close, notifications",
...
export const ticketingLiveTour: LiveTourDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      chapter: "create",
      title: "Attachments",
      body: "Drag and drop files, paste screenshots, or browse. Upload progress appears while files save — same experience as E-Forms. You can also add files later on the ticket detail page.",
      audience: "ticket_creator",
    },
    {
      id: "compose-submit",
    ...
    },
    {
      ...
      body: "Managers update status, priority, category, and assignee (search by name or email). Assignee choices come from the IT assignees list in Ticketing settings. Resolved tickets auto-close after the grace window and cannot be reopened once closed.",
      audience: "ticket_manager",
    ...
    },
    {
      ...
      body: "Under Settings, open Ticketing settings for IT assignees, categories, SLA / auto-close, assignment rules, and notifications.",
      audience: "ticket_settings",
    ...
    {
      id: "settings-it-assignees",
      path: "/ticketing/settings",
      target: "tk-settings-it-assignees",
      chapter: "settings",
      title: "IT assignees",
      body: "Curate who can be assigned tickets. Search and add IT users, then Save settings. Until this list is saved once, any active user remains assignable.",
      audience: "ticket_settings",
    },
    {
      id: "settings-sla",
      ...
      chapter: "settings",
      title: "SLA and auto-close",
      body: "Tenant defaults for response reminders and escalations (scheduler: ticketing:sla-run every 5 minutes). Set Auto-close resolved tickets after N days (default 3; 0 disables). Closed tickets cannot be reopened.",
      audience: "ticket_settings",
    },
    {
      id: "settings-notify",
