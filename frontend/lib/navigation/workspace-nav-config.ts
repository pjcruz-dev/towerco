...
export const workspaceQuickActions: WorkspaceQuickAction[] = [
  ...
  },
  {
    ...
    keywords: ["submit", "form", "request", "approval", "attachment", "upload"],
  },
  {
    id: "ea-my-approvals",
  ...
  },
  {
    ...
    module: "ticketing",
    permissions: ["ticketing:tickets:create"],
    keywords: ["support", "issue", "helpdesk", "attachment", "screenshot"],
  },
  {
    id: "ticketing-settings",
    title: "Ticketing settings",
    description: "IT assignees, categories, SLA, and auto-close",
    href: "/ticketing/settings",
    icon: Settings,
    module: "ticketing",
    permissions: ["ticketing:settings:manage"],
    keywords: ["assignee", "it pool", "sla", "auto-close", "categories", "notifications"],
  },
  {
    id: "doc-extract-new",
    title: "New DocExtract batch",
    description: "Upload documents and extract structured fields",
    href: "/doc-extract/new",
    icon: FileScan,
    module: "doc_extract",
    permissions: ["doc-extract:run"],
    keywords: ["ocr", "extract", "scan", "pdf", "upload", "template"],
  },
  {
    id: "account-security",
    title: "My security",
    description: "Passkeys, MFA authenticator, and sessions",
  ...
  },
  {
    id: "audit-trail",
    title: "Audit trail",
    description: "Workspace activity across modules",
    href: "/governance/audit",
    icon: ScrollText,
    permissions: ["workspace:audit:view"],
    keywords: ["audit", "activity", "log", "security", "ticket", "passkey"],
  },
  {
